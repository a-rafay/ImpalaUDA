...
public class BuiltinsDb extends Db {
  ...
  private void initAggregateBuiltins() {
   ...
   db.addBuiltin(AggregateFunction.createBuiltin(db, "corr",
        ...
        prefix +
            "10CorrUpdateEPN10impala_udf15FunctionContextERKNS1_9DoubleValES6_PNS1_9StringValE",
        prefix +
            "9CorrMergeEPN10impala_udf15FunctionContextERKNS1_9StringValEPS4_",
        prefix +
            "13CorrSerializeEPN10impala_udf15FunctionContextERKNS1_9StringValE",
        prefix +
